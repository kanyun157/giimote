...
function wm_set_dead_zone(num:real,type:real):real
...
// IR
const ir_screen_left 3
const ir_screen_right 2
const ir_screen_top 0
const ir_screen_bottom 1
...
#define wm_set_dead_zone
layer_function(global.gm_class,"wm_set_dead_zone",ty_real,2,argument0,argument1);
