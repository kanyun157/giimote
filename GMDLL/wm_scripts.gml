...
#define wm_get_moving
layer_function(global.gm_class,"wm_get_moving",ty_real,0);
#define wm_get_pitch
...
#define wm_get_report_continuous
layer_function(global.gm_class,"wm_get_report_continuous",ty_real);
