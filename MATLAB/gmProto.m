...
%This function was generated by loadlibrary.m parser version 1.1.6.20.4.1 on Fri Nov  7 22:17:30 2008
...
% exp double ret_one (); 
fcns.name{fcnNum}='ret_one'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='error'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
% exp double ret_two (); 
fcns.name{fcnNum}='ret_two'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='error'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
% exp double _stdcall ret_three (); 
fcns.name{fcnNum}='ret_three'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='error'; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
methodinfo=fcns;